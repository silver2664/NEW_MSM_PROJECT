...
<div class = "container-fluid">
	<div class = "row">
		...
		<div class = "col-lg-3 col-md-2 col-sm-2 mt-3" style = "border : 3px solid purple; height : 100vh;">Search And Category</div>
		<div class = "col-lg-8 col-md-9 col-sm-9 ml-3 mt-3">			
			<div class = "row">
				<div class = "card col-xl-3 col-md-3 col-sm-6 mb-2" style = "border : 1px solid black; height : 250px; margin : auto;">
					<img class = "card-img-top" src = "/resources/images/GOOD1.JPG" style = "max-width : 200px; max-h">
					<div class = "card-body">
						<h4 class = "card-title"><a>Goods1</a></h4>
						<p class = "card-text">$1,000</p>
					</div>
				</div>
				<div class = "col-xl-3 col-md-3 col-sm-6 mb-2" style = "border : 1px solid black; height : 250px; margin : auto;"></div>
				<div class = "col-xl-3 col-md-3 col-sm-6 lp;mb-2" style = "border : 1px solid black; height : 250px; margin : auto;"></div>										
			</div>
			<div class = "row">
				<div class = "col-xl-3 col-md-3 col-sm-6 mb-2" style = "border : 1px solid black; height : 250px; margin : auto;"></div>
				<div class = "col-xl-3 col-md-3 col-sm-6 mb-2" style = "border : 1px solid black; height : 250px; margin : auto;"></div>
